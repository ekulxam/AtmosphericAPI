...
public final class AtmosphericResourceManagerHelper {
    ...
    public static boolean registerBuiltinDataPack(Identifier id, ModContainer container, Component displayName, ResourcePackActivationType activationType) {
    ...
    public static boolean registerBuiltinSomething(Identifier id, ModContainer container, String subPath, Component displayName, ResourcePackActivationType activationType) {
