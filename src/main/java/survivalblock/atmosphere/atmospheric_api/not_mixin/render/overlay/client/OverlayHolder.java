...
public class OverlayHolder implements Comparable<OverlayHolder> {
    ...
    public OverlayHolder(Identifier texture, BiFunction<Minecraft, LocalPlayer, Float> opacityProvider) {
        this(texture, opacityProvider, BYPASSABLE_BY_DEFAULT, DEFAULT_PRIORITY);
    }

    public OverlayHolder(Identifier texture, BiFunction<Minecraft, LocalPlayer, Float> opacityProvider, int priority) {
        this(texture, opacityProvider, BYPASSABLE_BY_DEFAULT, priority);
    }

    public OverlayHolder(Identifier texture, BiFunction<Minecraft, LocalPlayer, Float> opacityProvider, boolean bypassable) {
        this(texture, opacityProvider, bypassable, DEFAULT_PRIORITY);
    }

    public OverlayHolder(Identifier texture, BiFunction<Minecraft, LocalPlayer, Float> opacityProvider, boolean bypassable, int priority) {
